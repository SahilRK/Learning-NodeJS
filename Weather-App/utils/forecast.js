...
const getWeatherDetails = (location,callback) => {
    const location_city = location.split(",")[0]
    const weather_url = `http://api.weatherstack.com/current?access_key=3920b29c3ecb693b904c073e28a23683&query=${location_city}`;
